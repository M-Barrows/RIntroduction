...
There are several steps you can take in order to make your projects more reporducible and reliable. The first of which is using *Projects*. [Here](http://uc-r.github.io/r_projects) is a nice write-up of how to get started with Projects. The main idea behind Projects is that all related files are bundled together in an organized file structure, making it easier to work with and share with others. 
