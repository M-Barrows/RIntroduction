...
As demonstrated by the process above, using plyr and dplyr creates a natural, readible code chunk that performs powerful transformations. Let's take a look at our last code chunk again, this time with comments outlining the purpose of each step: 
...
library %>% # Select the library dataset
  ...
  select(January, February, March, April, May, June, July, August, September, October, November, December) %>% # rearrange the month order
...
You can see that the dplyr syntax is almost as easily readible (and shorter) than plain English. This is what makes it so powerful. 
